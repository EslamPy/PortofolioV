...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/eslamdev/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@eslam.py",
    icon: Instagram,
    url: "https://www.instagram.com/eslam.py/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@EslamCode",
    icon: Youtube,
    url: "https://www.youtube.com/@EslamCode",
    color: "#FF0000",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@Microsoft",
    color: "black",
