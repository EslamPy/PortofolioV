...
import { Code, Award, Boxes, Sparkles, Briefcase } from "lucide-react";
...
const ToggleButton = ({ onClick, isShowingMore }) => (
  ...
  >
    ...
    <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-primary-500/50 transition-all duration-300 group-hover:w-full"></span>
  </button>
);
...
// Work Experience Data is now imported from '../data/workExperiences'
// The workExperiences array is imported at the top of the file
        ...
        <AppBar
          ...
          sx={{
            ...
            "&::before": {
              ...
              right: 0,
              bottom: 0,
              background: "linear-gradient(180deg, rgba(14, 165, 233, 0.03) 0%, rgba(16, 185, 129, 0.03) 100%)",
        ...
        >
          ...
          >
            ...
            <Tab
              ...
              label="Tech Stack"
              onClick={() => document.getElementById('techstack-section').scrollIntoView({ behavior: 'smooth' })}
              {...a11yProps(2)}
            />
            <Tab
